						...
						<tbody>
							...
							?>
									<tr>
										...
										<td><a href="javascript:;" onclick="pilih_rincian('<?php echo $row['id'] ?>','<?php echo $row['kode'] . ' - ' . $row['nama'] ?>')" class="btn btn-xs btn-primary">Pilih</a></td>
									</tr>
							<?php
									$i++;
								}
...
<script type="text/javascript">
	function pilih_rincian(id, nama) {
		$("input[name='id_bidang']").val(id);
		$("input[name='nama_bidang']").val(nama);
