...
<form rel="ajax-file" enctype="multipart/form-data" id="form_<?php echo $isProses?>" action="<?php echo $url_action ?>" class="panel form-horizontal xhr dest_subcontent-element" method="post">
	...
	<input type="text" name="encId" value="<?php echo $encId?>">
			...
			<div class="col-sm-12">
				<div class="row form-group">
					...
					<div class="col-sm-8">
						...
						<input type="text" autocomplete="off" placeholder="No. SIP" class="form-control" name="noref" value="<?php echo  set_value('noref',isset($objPengguna) ? $objPengguna['asetGunaNoRef'] : '') ?>">
				...
				<div class="row form-group">
					...
					<div class="col-sm-3">
						<div class="input-group date day">
							...
							value="<?php echo  set_value('tgl',isset($objPengguna) ? $objPengguna['asetGunaTglSip'] : '') ?>"><span
					...
					<div class="col-sm-8">
						<label class="custom-file px-file">
							...
							<span class="custom-file-control form-control">
								<?php
								$asetGunaFile = !empty($objPengguna)?$objPengguna['asetGunaFile']:'';
								if(!empty(set_value('fileSip[]')) || !empty($objPengguna['asetGunaFile'])){
									echo empty(set_value('fileSip[]'))?$objPengguna['asetGunaFile']:set_value('fileSip[]');
								}else{
									echo "Pilih file ... ";
								}
				...
				<div class="row form-group">
					...
					<div class="col-sm-3">
						<select name="stat" class="form-control">
							<?php 
							if(!empty($objPengguna)){
								$stat_y='';
								$stat_n='';
								($objPengguna['asetGunaAktif']=='Y')?$stat_y='1':$stat_n='1';
							}else{
								$stat_y='n';
								$stat_n='';
							...
							?>
							<option value="Y" <?php echo (!empty($stat_y))?'selected="selected"':''?> >Aktif</option>
							<option value="N" <?php echo (!empty($stat_n))?'selected="selected"':''?> >Expired</option>
						</select>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="row form-group">
					...
					<div class="col-sm-3">
						<textarea class="form-control" placeholder="Keterangan" name="ket"><?php echo set_value('ket',isset($objPengguna) ? $objPengguna['asetGunaKet'] : '')?></textarea>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							...
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="Nama pemberi izin" class="form-control" name="pnama" value="<?php echo  set_value('pnama',isset($objPengguna) ? $objPengguna['asetGunaNamaPemberi'] : '') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							...
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="NIM pemberi izin" class="form-control" name="pnip" value="<?php echo  set_value('pnip',isset($objPengguna) ? $objPengguna['asetGunaNIPPemberi'] : '') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							...
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="Jabatan pemberi izin" class="form-control" name="pjab" value="<?php echo  set_value('pjab',isset($objPengguna) ? $objPengguna['asetGunaJbtnPemberi'] : '') ?>">
								...
								<select class="form-control" name="punit" id="punit">
									...
									if(!empty($data_punit)){
										foreach($data_punit as $key_punit => $row_punit){
											if(set_value('punit',isset($objPengguna) ? $objPengguna['asetGunaUnitPemberi'] : '')==$row_punit['id']){
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							<label class="col-sm-2 control-label" style='text-align:left;'>Nama</label>
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="Nama pengguna" class="form-control" name="nama" value="<?php echo  set_value('nama',isset($objPengguna)?$objPengguna['asetGunaNama']:'') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							<label class="col-sm-2 control-label" style='text-align:left;'>NIP</label>
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="NIM pengguna" class="form-control" name="nip" value="<?php echo  set_value('nip',isset($objPengguna)?$objPengguna['asetGunaNIP']:'') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							<label class="col-sm-2 control-label" style='text-align:left;'>Jabatan</label>
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="Jabatan Pengguna " class="form-control" name="jab" value="<?php echo  set_value('jab',isset($objPengguna)?$objPengguna['asetGunaJabatan']:'') ?>">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row form-group">
							...
							<div class="col-sm-3">
								<input type="text" autocomplete="off" placeholder="NIM pengguna" class="form-control" name="telp" value="<?php echo  set_value('telp',isset($objPengguna)?$objPengguna['asetGunaNoTelp']:'') ?>">
								...
								<select class="form-control" name="unit" id="unit">
									...
									if(!empty($data_unit)){
										foreach($data_unit as $key_unit => $row_unit){
											if(set_value('unit',isset($objPengguna)?$objPengguna['asetGunaUnitId']:'')==$row_unit['id']){
				...
				<div class="table-primary">
					<div style="overflow: auto;">
						<table id="tbl-rincian" class="table table-bordered">
							...
							<?php 
							$i = 0;
							foreach ($objPenggunaDetail as $key_detail => $row_detail) {
							...
							?>
								...
								<td><?php echo $i++?></td>
								<td><?php echo $row_detail['asetGunaDetKodeBrg']?></td>
								<td><?php echo $row_detail['barang_nama']?></td>
								<td><?php echo $row_detail['barang_merk']?></td>
								<td><?php echo $row_detail['barang_tanggal']?></td>
								<td><?php echo $row_detail['barang_nilai_perolehan']?></td>
								<td><?php echo $row_detail['unit_nama']?></td>
								<td><textarea name="keterangan[]" placeholder="Masukan keterangan" class="form-control"><?php echo $row_detail['asetGunaDetKet']?></textarea></td>
								<td>
									<input type="text" name="inv_det_id[]"  value="<?php echo $row_detail['asetGunaDetBrgId']?>">
									<input type="text" name="barang_kode[]"  value="<?php echo $row_detail['asetGunaDetKodeBrg']?>">
									<input type="text" name="kondisi[]"  value="<?php echo $row_detail['asetGunaDetKmblKond']?>">
									<input type="text" name="unit_id[]"  value="<?php echo $row_detail['asetGunaDetUnitId']?>">
									<input type="text" name="nilOleh[]"  value="<?php echo $row_detail['barang_nilai_perolehan']?>">
									<button type="button" class="btn btn-danger btn-sm btn-hapus" data-toggle="tooltip" data-placement="top" value="<?php echo $row_detail['asetGunaDetBrgId']?>" title="hapus"><span class="icon fa fa-trash-o"></span></button>
								</td>
								</tr>
							<?php } ?>
							</tbody>
