...
<form id="form-filter" rel="ajax" action="<?php echo $linkView; ?>" class="panel form-horizontal xhr dest_subcontent-element" method="post" >
	...
	<div class="panel-body">
		<div class="row form-group">
			<label class="col-sm-3 control-label" style="text-align:left;">No. SK Penghapusan</label>
			<div class="col-sm-4">
				<input type="input" id="search" name="search" value="<?php echo (!empty($search)?$search:'')?>" class="form-control" placeholder="" />
			</div>	
		</div>
				...
				<table class="table table-bordered table-hover table-striped">
					<thead>
						<tr>
							...
							<th style="text-align: center;">Nomor SK Penghapusan</th>
					...
					echo "<tr><td colspan='9'><div class='alert alert-danger'>Data Penghapusan Aset Tidak Ditemukan</div></td></tr>";
				}
				?>
                </tbody>
				</table>
