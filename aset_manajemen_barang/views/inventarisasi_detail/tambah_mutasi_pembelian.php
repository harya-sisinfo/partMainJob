...
<form rel="ajax-file" enctype="multipart/form-data" id="add_mutasi_pembelian" action="<?php echo $form_action; ?>" class="panel form-horizontal xhr dest_subcontent-element" method="post">
	...
	<div class="panel-heading">
		<span class="panel-title"><b>Tambah</b> Mutasi Pembelian</span>
	</div>
