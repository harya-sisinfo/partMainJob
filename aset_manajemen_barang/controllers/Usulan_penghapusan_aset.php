...
/**
 * Controller Usulan Penghapusan Aset
 * @created : August 26, 2021 12:16 AM
 * @author  : Alfian Hidayat <hidayat_alfian@ugm.ac.id>
 * @company : DSSDI UGM
**/

class Usulan_penghapusan_aset extends UGM_Controller {
	...
	public function __construct() {
		...
		$this->load->model('Model_usulan_penghapusan_aset', 'model');

		$this->ret_url          = site_url('aset_manajemen_barang/usulan_penghapusan_aset/view');
	...
	public function index() {
		redirect('aset_manajemen_barang/usulan_penghapusan_aset/view');
	}
    
	public function view($offset='', $search='', $jenis='', $unit_kerja=''){
		$data['linkView'] = site_url('aset_manajemen_barang/usulan_penghapusan_aset/view');
		$data['linkAdd'] = site_url('aset_manajemen_barang/usulan_penghapusan_aset/add');
		...
		if ($this->input->server('REQUEST_METHOD') == 'POST' || !empty($offset)) {
			...
			// ==========================================================================
			$this->load->library('jquery_pagination');
			$config['base_url']         = site_url('aset_manajemen_barang/usulan_penghapusan_aset/view/');
	...
	public function add($id=null){
        $data['form_action'] = site_url() . "aset_manajemen_barang/usulan_penghapusan_aset/add_proses";
