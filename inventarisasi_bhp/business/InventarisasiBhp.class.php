<?php
class InventarisasiBhp extends Database
{
   protected $mSqlFile= 'module/inventarisasi_bhp/business/inventarisasi_bhp.sql.php';
   ...
   function GetSubKelompokList()
   {
	...
	function GenerateNumber($kode_barang)
   {
		$result = $this->Open($this->mSqlQueries['get_data_last_number'], array($kode_barang));
		return $result;
   }
	
	function GetInventarisasiBhpById($id)
   {
		$result = $this->Open($this->mSqlQueries['get_data_detil_barang_by_id'], array($id));
		return $result;
   }

   function ExportExcel(){
      return $this->Open($this->mSqlQueries['export_excel'], array());
   }
	
	function DoInsertDetilBHP($data)
   {
		$result = $this->Execute($this->mSqlQueries['do_insert_detil_bhp'], $data);
		return $result;
   }
	
	function DoUpdateDetilBHP($data)
   {
		$result = $this->Execute($this->mSqlQueries['do_update_detil_bhp'], $data);
		return $result;
   }
}
?>